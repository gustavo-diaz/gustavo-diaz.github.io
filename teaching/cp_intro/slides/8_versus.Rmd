...
- **Normatively:** We want believe that democracy leads to better outcomes
...
- We can find democracies and dictatorships with high and low rule of law
...
- Implicitly, we are assuming that **economic growth is a necessary condition** for all other other good things `(e.g. wages, healthcare, education, pensions, security, infrastructure, freedom)`
...
- A **necessary** cause is one without which we would not observe the outcome, but that does not imply that it always produces the outcome

- A **sufficient** cause is one with which we would always observe the outcome, but there may be alternative causes

- Causes can be either **necessary** or **sufficient**, or **both** at the same time
...
- The triangles of empty spaces suggest two things:
...
- We should read these results as democracy being **necessary** to guarantee **the most basic living conditions**

- These conditions are in turn **also necessary** for more ambitious dimensions of well-being `(e.g. education, wages)`

- That does not mean that democracy is **sufficient**

---
## What does this all mean?

- Democracy is **necessary** but not **sufficient** for material well-being
