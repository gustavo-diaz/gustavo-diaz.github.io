...
- But also pointed out that many improvements to material well-being in democracies happened **before democratization**
...
- In this case, councillors will vote on every possible combination of alternative pairs and we will see which alternative wins more rounds
...
- **Chaos theorem:**  
    ...
    - `(Make sure you understand the two-dimensional voting figures in the book)`
...
- Also, most meaningful decision bodies have more members than a handful
...
- Does that mean we should drop democracy?
...
- Four **fairness conditions**:
    ...
    1. **Non-dictatorship:** No individual who fully determines the outcome
    
    2. **Universal admissibility:** Individuals can adopt any rational preference ordering
    
    3. **Unanimity (pareto optimality):** If everyone prefers $x \geq y$, the then group should not choose $y$ if $x$ is available
    
    4. **Idependence of irrelevant alternatives (IIA):** Introducing irrelevant alternatives does not affect the outcome
    
--

- We normally assume **3** and **4** are uncontroversial. We want better outcomes from society and we want to weed out irrelevant alternatives
...
- **To function properly, democracy has to systematically exclude a non-trivial proportion of the population**
