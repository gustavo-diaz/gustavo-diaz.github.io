...
```{r setup, include=F}
# a name for methods fields to change depending on job ad language
methods = "causal inference"
```

# Research 

My work contributes to two research programs. Methodologically, I use tools from design-based causal inference, computational social science, and machine learning to improve research design in experiments and observational studies, with emphasis on tools to for understanding hard-to-observe social and political phenomena. My current research on this topic focuses on two areas: modeling spillovers with partially unobserved networks and navigating the bias-variance trade-off in the design and analysis of field and survey experiments. Substantively, I research political economy and political behavior in the Global South, with a focus on how information shapes accountability and representation. My main research agenda on this topic leverages a novel data collection effort in Brazil to study the unintended electoral consequences of exposing corruption that stem from politicians' strategic behavior. 
...
While my efforts so far surround teaching and learning, I see a position at Microsoft as an opportunity to translate these ideas into a sustainable and inclusive research program. I believe your collaborative workflow is the template to follow to pursue innovative research that respects and values the skills and contributions of all members. This framework not only creates a space for diverse voices, but also provides enough flexibility to foster dialogue across backgrounds and career stages.
