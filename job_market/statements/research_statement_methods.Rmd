...
My work contributes to two research programs. Methodologically, I use tools from data science and design-based causal inference to improve research design in experiments and observational studies, with emphasis on tools to for understanding hard-to-observe social and political phenomena. My current research on this topic focuses on two areas: modeling spillovers with partially unobserved networks and navigating the bias-variance trade-off in the design and analysis of field and survey experiments. Substantively, I research evidence based policy-making in the Global south from the lenses of political economy and political behavior, with a focus on how information shapes accountability and representation. My main research agenda on this topic leverages a novel data collection effort in Brazil to study the unintended electoral consequences of exposing corruption that stem from politicians' strategic behavior. 

# Improving tools to understand hard-to-observe phenomena

At its core, empirical social science, including political science, is about simplifying complex phenomena. To simplify, researchers must make assumptions in how they collect and analyze data. A great deal of research in `r methods` entails outlining a sufficient set of assumptions to identify a phenomenon of interest, and then deriving tools to analyze data in conformity with those assumptions. While most work in this area focuses on leveraging new technologies and data sources to develop new methods with new assumptions, my work focuses on applying these cutting-edge tools in less than ideal circumstances, primarily to questions of interest in the Global South. Within this framework, I use tools from data science and design-based causal inference to improve research design in experiments and observational studies.
