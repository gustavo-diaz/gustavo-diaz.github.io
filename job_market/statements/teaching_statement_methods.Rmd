...
```{r setup, include=F}
source = "website"
substance = "political science"
methods = "quantitative methods"
```

I approach teaching `r substance` and `r methods` as the task of acquiring a new language. I recognize that my students come from different paths and have different career goals. Therefore, I aim to identify key ideas and skills to help
...
I have experience teaching substantive and methodological courses to diverse audiences and under different formats. At Tulane, I teach introduction to comparative politics, emphasizing theoretical considerations and policy implications as the core of the course, while simultaneously encouraging students to apply this knowledge to recent events in a region or country of their choosing. In Spring 2022, I will teach a course on the use of evidence-based policy making to adress social and political challenged in developing democracies.
...
I am prepared to teach courses on causal inference, computational social science, evidence-informed policy making, and  the politics of the Global South. You can find copies of current and sample syllabi in my `r source`.