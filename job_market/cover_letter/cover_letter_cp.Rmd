...
Substantively, I research `r area` with a focus on the challenges to accountability and representation `r region`. Methodologically, I use tools from `r tools` to develop standards to navigate research design tradeoffs in experiments and quasi-experiments.
