...
My research uses tools from `r tools` to develop standards to navigate research design trade-offs in experiments and quasi-experiments. My contributions are informed by my substantive work on the challenges to accountability and representation in `r region`.
