...
Substantively, I study political economy and political behavior in the Global South, with a focus on how information shapes accountability and representation`r ifelse(latam == TRUE, print(" in Latin America."), print("."))` Methodologically, I focus on the application of tools from design-based causal inference and machine learning to improve research design in experiments and observational studies. My teaching on both areas emphasizes acquiring the language of the social sciences and its application to topics that extend beyond the classroom.

<!-- TEACHING -->
<!-- UIUC -->
I have experience teaching courses in comparative politics and quantitative methods. At Tulane, I teach Introduction to Comparative Politics, focusing on theoretical and methodological considerations. In Spring 2022, I will teach on the challenges of developing democracies from an evidence-informed policy perspective. In my time at Illinois, I taught an online course on the politics of developing countries as an independent instructor and served as a teaching assistant for its in-person version. I also served as a teaching assistant for a quantitative research methods courses at the undergraduate and PhD levels using a flipped classroom approach. I served as a math camp instructor for incoming graduate students for three consecutive years and started a collaborative project in which graduate students introduced their peers to new methodological tools. These experiences have prepared me to teach to a diverse student body and to adapt to both online and in-person platforms.

<!-- Teaching plans -->
<!-- Remember to switch from teaching portfolio/website accordingly -->
<!-- Also tweak depending on job -->
I am prepared to teach courses on international development, the politics of the Global South, quantitative methods, and research design. You can find copies of current and sample syllabi in my website. As a first-generation scholar, my teaching philosophy emphasizes building the creation of flexible learning environments for students with different backgrounds, learning styles, and career goals.
